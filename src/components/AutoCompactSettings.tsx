    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className={cn("max-w-4xl max-h-[85vh] overflow-hidden", className)}>
        <DialogHeader>
          ...
          <DialogDescription>{t("autoCompact.subtitle")}</DialogDescription>
        </DialogHeader>
        ...
        <Tabs value={activeTab} className="flex-1 overflow-hidden" onValueChange={setActiveTab}>
          ...
          <TabsContent value="config" className="space-y-6 overflow-auto max-h-[calc(85vh-200px)]">
            <Card>
              <CardHeader>
                ...
                <CardDescription>{t("autoCompact.basicSettingsDescription")}</CardDescription>
              </CardHeader>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <Badge variant="secondary">
                      {Math.round(config.compaction_threshold * 100)}%
                    </Badge>
                  </div>
                  <div className="px-2">
                    <input
                      ...
                      onChange={(e) =>
                        handleConfigChange({ compaction_threshold: parseFloat(e.target.value) })
                      }
                      max={1.0}
                      min={0.5}
                      step={0.05}
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>{t("autoCompact.strategyDescription")}</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  ...
                  <Select
                    value={
                      typeof config.compaction_strategy === "string"
                    ...
                    onValueChange={(value) => {
                      if (value === "Custom") {
                        handleConfigChange({
                          compaction_strategy: { Custom: config.custom_instructions || "" },
                        });
                      } else {
                        handleConfigChange({
                      ...
                      <SelectItem value="Smart">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-muted-foreground">
                              {t("autoCompact.smartCompressionShort")}
                            </p>
                          </div>
                        </div>
                      </SelectItem>
                      <SelectItem value="Aggressive">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-muted-foreground">
                              {t("autoCompact.aggressiveCompressionShort")}
                            </p>
                          </div>
                        </div>
                      </SelectItem>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <p className="font-medium">
                              {t("autoCompact.conservativeCompression")}
                            </p>
                            <p className="text-xs text-muted-foreground">
                              {t("autoCompact.conservativeCompressionShort")}
                            </p>
                          </div>
                        </div>
                      </SelectItem>
                      <SelectItem value="Custom">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-muted-foreground">
                              {t("autoCompact.customCompressionShort")}
                            </p>
                          </div>
                        </div>
                      </SelectItem>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="space-y-1">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm">
                          {status.enabled
                            ? t("autoCompact.statusEnabled")
                            : t("autoCompact.statusDisabled")}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="space-y-1">
                      <p className="text-sm font-medium text-muted-foreground">
                        {t("autoCompact.monitoringSessions")}
                      </p>
                      <div className="flex items-center gap-2">
                    ...
                    <div className="space-y-1">
                      <p className="text-sm font-medium text-muted-foreground">
                        {t("autoCompact.totalCompactions")}
                      </p>
                      <div className="flex items-center gap-2">
                    ...
                    <div className="space-y-1">
                      <p className="text-sm font-medium text-muted-foreground">
                        {t("autoCompact.compactionThresholdLabel")}
                      </p>
                      <div className="flex items-center gap-2">
                        <Gauge className="h-4 w-4 text-purple-500" />
                        <span className="text-sm">
                          {formatTokenCount(
                            Math.round(status.max_context_tokens * status.compaction_threshold)
                          )}
                        </span>
                      </div>
                    </div>
          ...
          <TabsContent
            value="sessions"
            className="space-y-4 overflow-auto max-h-[calc(85vh-200px)]"
          >
            <Card>
              <CardHeader>
                ...
                <CardDescription>{t("autoCompact.activeSessionsDescription")}</CardDescription>
              </CardHeader>
              <CardContent>
                {sessions.length === 0 ? (
                            ...
                            <div className="w-full bg-gray-200 rounded-full h-2">
                              <div
                                className={cn(
                                  ...
                                  session.current_tokens / config.max_context_tokens >
