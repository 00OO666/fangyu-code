                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-md w-full mx-4 p-6">
                            ...
                            <div>
                                ...
                                <div className="space-y-2">
                                    <label className={cn(
                                        ...
                                        />
                                        <div>
                                            <span className="block text-sm font-medium text-gray-900 dark:text-gray-100">合并</span>
                                            <span className="block text-xs text-gray-500 dark:text-gray-400">保留现有配置，添加或更新导入的配置</span>
                                        </div>
                                    </label>
                                    <label className={cn(
                                        'flex items-start gap-3 p-3 rounded-lg border cursor-pointer',
                                        ...
                                        />
                                        <div>
                                            <span className="block text-sm font-medium text-gray-900 dark:text-gray-100">替换</span>
                                            <span className="block text-xs text-gray-500 dark:text-gray-400">清空现有配置，使用导入的配置</span>
                                        </div>
                                    </label>
                                </div>
                            </div>
                        ...
                        <div className="flex justify-end gap-2 mt-6">
                            <button
                                type="button"
                                onClick={() => { setDialog(null); setImportData(null); }}
                                className="px-4 py-2 text-sm font-medium text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors"
                            >
                                取消
                            </button>
