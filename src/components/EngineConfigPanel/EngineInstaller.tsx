    ...
    <div className="p-4 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-medium text-gray-900 dark:text-gray-100">安装 {config.name}</h3>
        </div>
        <button
          onClick={onClose}
      ...
      {config.command && (
        <div className="flex items-center gap-2 p-2 bg-gray-100 dark:bg-gray-800 rounded-lg font-mono text-sm">
          ...
          <code className="text-gray-700 dark:text-gray-300 break-all">{config.command}</code>
        </div>
      )}
        ...
        <div className="p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
          <div className="flex items-start gap-2">
            ...
            <div className="space-y-1">
              <p className="text-sm text-green-700 dark:text-green-300">{config.name} 安装成功！</p>
