...
export const BUILT_IN_SLASH_COMMANDS: SlashCommand[] = [
  ...
  {
    name: "terminal-setup",
    description: "安装 Shift+Enter 快捷键",
    source: "built-in",
    category: "config",
    supportsNonInteractive: false,
  },
