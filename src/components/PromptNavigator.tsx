                                ...
                                {prompt.costDetails && prompt.costDetails.length > 0 && (
                                  <div className="space-y-1">
                                    ...
                                    {prompt.costDetails.map((detail, idx) => (
                                      <div key={idx} className="flex justify-between items-start gap-3 py-0.5 border-b border-border/30 last:border-0">
                                ...
                                <div className="space-y-2">
                                  ...
                                  {prompt.costDetails && prompt.costDetails.length > 0 && (
                                    <div className="space-y-1">
                                      ...
                                      {prompt.costDetails.map((detail, idx) => (
                                        <div key={idx} className="flex justify-between items-start gap-3 py-1 border-b border-border/30 last:border-0">
                                          <div className="flex-1 min-w-0">
