...
export function SmartRecommendationBar({
  ...
  const currentRec =
    recommendations[Math.min(currentIndex, recommendations.length - 1)] || recommendations[0];
  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        {/* 图标 - 带发光效果 */}
        <motion.div
          className={cn("p-2 rounded-lg", config?.bgClass, "relative")}
