    ...
    <div className={cn("flex flex-col gap-1 w-full", className)}>
      {compact ? (
                  ...
                  <div className="relative group cursor-default">
                    <engine.icon
                      className={cn(
                        ...
                        engine.isInstalled ? engine.color : "text-muted-foreground/40"
                      )}
                    />
                    <div
                      className={cn(
        ...
        <div className="space-y-2 px-2">
          <div className="text-xs font-medium text-muted-foreground mb-1 ml-1">引擎状态</div>
              ...
              >
                <div className="flex items-center gap-2">
                  <engine.icon
                    className={cn(
                      "h-3.5 w-3.5",
                      engine.isInstalled ? engine.color : "text-muted-foreground"
                    )}
                  />
                  <span className={cn("text-xs", !engine.isInstalled && "text-muted-foreground")}>
                    {engine.label}
                  </span>
                </div>
