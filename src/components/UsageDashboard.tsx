...
export const UsageDashboard: React.FC<UsageDashboardProps> = ({ onBack }) => {
  ...
  const [_hourlyData, _setHourlyData] = useState<
    { hour: number; cost: number; tokens: number; count: number }[]
  >([]);
      ...
      <div className="grid grid-cols-4 gap-2">
        ...
        <Card className="p-2.5 shimmer-hover">
          <div>
            ...
            <p className="text-lg font-bold mt-0.5">{formatNumber(totalSessions)}</p>
          </div>
        </Card>
        ...
        <Card className="p-2.5 shimmer-hover">
          <div>
            ...
            <p className="text-lg font-bold mt-0.5">{formatTokens(totalTokens)}</p>
          </div>
        </Card>
        ...
        <Card className="p-2.5 shimmer-hover">
          <div>
            <p className="text-[10px] text-muted-foreground">
              {t("usageDashboard.averageCostPerSession")}
            </p>
            <p className="text-lg font-bold mt-0.5">
              {formatCurrency(totalSessions > 0 ? totalCost / totalSessions : 0)}
            </p>
          </div>
        </Card>
      </div>
  ...
  const mostUsedModels = useMemo(() => {
    ...
    return currentStats.by_model.slice(0, 3).map((model: ModelUsage & { engine?: EngineType }) => {
      ...
      const EngineIcon =
        model.engine === "codex" ? CodexIcon : model.engine === "gemini" ? GeminiIcon : ClaudeIcon;
      return (
        <div
          key={`${model.engine || "claude"}-${model.model}`}
  ...
  const topProjects = useMemo(() => {
    ...
    return currentStats.by_project
      .slice(0, 3)
      .map((project: ProjectUsage & { engine?: EngineType }) => {
        const engineColor = project.engine ? ENGINE_COLORS[project.engine] : ENGINE_COLORS.claude;
        const EngineIcon =
          project.engine === "codex"
            ? CodexIcon
            : project.engine === "gemini"
              ? GeminiIcon
              : ClaudeIcon;
        return (
          <div
            key={`${project.engine || "claude"}-${project.project_path}`}
            className="flex items-center justify-between"
          >
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col">
                <span
                  className="text-body-small font-medium truncate max-w-[180px]"
                    ...
                    >
                      {range === "today"
                        ...
                        : range === "all"
                          ...
                          : range === "7d"
                            ? t("usageDashboard.last7Days")
                            : t("usageDashboard.last30Days")}
                    </Button>
                  ))}
                </div>
              </div>
              ...
              <div className="flex items-center gap-1.5">
                ...
                <div className="flex gap-1">
                  ...
                  <Button
                    ...
                    style={{
                      borderColor: selectedEngine === "claude" ? ENGINE_COLORS.claude : undefined,
                    }}
                  >
                  ...
                  <Button
                    ...
                    className="h-7 text-xs px-2 gap-1"
                    style={{
                      borderColor: selectedEngine === "codex" ? ENGINE_COLORS.codex : undefined,
                    }}
                  >
                  ...
                  <Button
                    ...
                    className="h-7 text-xs px-2 gap-1"
                    style={{
                      borderColor: selectedEngine === "gemini" ? ENGINE_COLORS.gemini : undefined,
                    }}
                  >
            ...
            <div className="space-y-4">
              ...
              >
                <TabsList className="grid grid-cols-5 w-full mb-3 h-auto p-0.5">
                  <TabsTrigger value="overview" className="py-1.5 px-2 text-xs">
                    {t("common.overview")}
                  </TabsTrigger>
                  <TabsTrigger value="models" className="py-1.5 px-2 text-xs">
                    {t("usage.byModel")}
                  </TabsTrigger>
                  <TabsTrigger value="projects" className="py-1.5 px-2 text-xs">
                    {t("usage.byProject")}
                  </TabsTrigger>
                  <TabsTrigger value="sessions" className="py-1.5 px-2 text-xs">
                    {t("common.sessions")}
                  </TabsTrigger>
                  <TabsTrigger value="timeline" className="py-1.5 px-2 text-xs">
                    {t("common.timeline")}
                  </TabsTrigger>
                </TabsList>
                ...
                <TabsContent value="overview" className="space-y-3 mt-3">
                    ...
                    <div className="grid grid-cols-4 gap-2">
                      <div>
                        ...
                        <p className="text-sm font-semibold">
                          {formatTokens(currentStats?.total_input_tokens || 0)}
                        </p>
                      </div>
                      <div>
                        <p className="text-[10px] text-muted-foreground">
                        ...
                        <p className="text-sm font-semibold">
                          {formatTokens(currentStats?.total_output_tokens || 0)}
                        </p>
                      </div>
                      <div>
                        <p className="text-[10px] text-muted-foreground">
                        ...
                        <p className="text-sm font-semibold">
                          {formatTokens(currentStats?.total_cache_creation_tokens || 0)}
                        </p>
                      </div>
                      <div>
                        <p className="text-[10px] text-muted-foreground">
                        ...
                        <p className="text-sm font-semibold">
                          {formatTokens(currentStats?.total_cache_read_tokens || 0)}
                        </p>
                      </div>
                    </div>
                  </Card>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <Card className="p-3">
                      ...
                      <div className="space-y-2">{mostUsedModels}</div>
                    </Card>
                    ...
                    <Card className="p-3">
                      ...
                      <div className="space-y-2">{topProjects}</div>
                    </Card>
                  </div>
                </TabsContent>
                    ...
                    <div style={{ display: activeTab === "models" ? "block" : "none" }}>
                      <Card className="p-3">
                        ...
                        <div className="space-y-2">
                          {(currentStats.by_model || []).map(
                            (model: ModelUsage & { engine?: EngineType }) => {
                              const engineColor = model.engine
                                ? ENGINE_COLORS[model.engine]
                                : ENGINE_COLORS.claude;
                              const EngineIcon =
                                model.engine === "codex"
                                  ? CodexIcon
                                  : model.engine === "gemini"
                                ...
                                >
                                  <div className="flex items-center justify-between">
                                    <div className="flex items-center space-x-3">
                                      ...
                                      <Badge
                                        ...
                                        style={{
                                          borderColor:
                                            selectedEngine === "all" ? engineColor : undefined,
                                        }}
                                      >
                                        {getModelDisplayName(model.model)}
                                      </Badge>
                                  ...
                                  <div className="grid grid-cols-4 gap-2 text-xs">
                                    ...
                                    <div>
                                      ...
                                      <span className="font-medium">
                                        {formatTokens(model.cache_creation_tokens || 0)}
                                      </span>
                                    </div>
                                    <div>
                      ...
                      <Card className="p-3">
                        <div className="flex items-center justify-between mb-2">
                          <h3 className="text-xs font-medium">
                            {t("usageDashboard.projectStats")}
                          </h3>
                          <span className="text-[10px] text-muted-foreground">
                            {currentStats.by_project?.length || 0}{" "}
                            {t("usageDashboard.totalProjects")}
                          </span>
                        </div>
                        <div className="space-y-2">
                          {(() => {
                            ...
                            return (
                              <>
                                {paginatedProjects.map(
                                  (project: ProjectUsage & { engine?: EngineType }) => {
                                    const engineColor = project.engine
                                      ? ENGINE_COLORS[project.engine]
                                      : ENGINE_COLORS.claude;
                                    const EngineIcon =
                                      project.engine === "codex"
                                        ? CodexIcon
                              ...
                              <Button
                                ...
                                onClick={() => {
                                  if (
                                    ...
                                    timelineChartData &&
                                    timelineChartData.bars.length > 0
                                  ) {
                                    const latestDate =
                                      timelineChartData.bars[timelineChartData.bars.length - 1]
                                        .dateStr;
                            ...
                            <div className="overflow-x-auto pb-14 scrollbar-thin scrollbar-thumb-blue-500/20 scrollbar-track-transparent">
                              <div className="flex items-end gap-1.5 h-48 pt-5 border-l-2 border-b-2 border-blue-500/20 pl-3 rounded-bl-lg min-w-[800px] relative">
                                ...
                                {hourlyChartData.bars.map((hourData, index) => {
                                  ...
                                  const gradientIntensity = Math.min(
                                    hourData.heightPercent / 100,
                                    1
                                  );
                                  ...
                                  return (
                                    ...
                                    >
                                      ...
                                      <motion.div
                                        ...
                                        style={{
                                          height:
                                            hourData.heightPercent > 0
                                              ? `${(hourData.heightPercent / 100) * 192}px`
                                              : "3px",
                                          ...
                                          boxShadow:
                                            hourData.cost > 0 && hourData.heightPercent > 0
                                              ? isPeakHour
