...
+const result = hello('Fangyu');`}
          ...
          <div className="h-full flex flex-col">
            ...
            <div className="flex-1 flex items-center justify-center p-8">
              <div className="text-center max-w-md">
                {featureInfo && (
                  <featureInfo.icon className={`w-24 h-24 mx-auto mb-6 ${featureInfo.color}`} />
                )}
        ...
        return (
          <div className="p-6">
            <div className="mb-6">
              ...
              <p className="text-muted-foreground">探索所有新功能，点击卡片查看详情和演示</p>
            </div>
            ...
            <div className="mt-8 p-4 bg-muted rounded-lg">
              ...
              <ul className="text-sm text-muted-foreground space-y-1">
                ...
                <li>
                  • 🚧 开发中：代码片段库、Git 可视化、测试集成、项目模板、性能分析器、插件系统
                </li>
  ...
  return (
    <div className="h-full flex flex-col bg-background">
      ...
      <div className="flex-1 overflow-auto">{renderFeatureContent()}</div>
    </div>
  );
};
