...
import { Sparkles, Send, History, Code, FileCode, FileText, Wand2, TestTube, MessageSquare, X, Copy, Check, Loader2, BookOpen, Bug, Zap, Trash2, User, Maximize2, Minimize2, Pin, PinOff } from 'lucide-react';
