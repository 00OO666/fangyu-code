...
import { ChevronRight, Loader2, CheckCircle, AlertCircle, Clock, Copy, Check } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* 状态标签 */}
        <span
          className={cn("text-[10px] px-1.5 py-0.5 rounded", config.bgClass, config.colorClass)}
        >
          {config.label}
        </span>
      </button>
