...
async function testClaudeModel(modelId: string, apiKey: string, baseUrl: string): Promise<ModelTestResult> {
...
async function testOpenAIModel(modelId: string, apiKey: string, baseUrl: string): Promise<ModelTestResult> {
    const startTime = Date.now();
    try {
...
async function testGeminiModel(modelId: string, apiKey: string, baseUrl: string): Promise<ModelTestResult> {
    const startTime = Date.now();
    try {
                    ...
                    <div className="flex items-center justify-between mb-3">
                        ...
                        <div className="flex items-center gap-2">
                            <button
                                ...
                                className={`px-3 py-1 text-xs rounded transition-colors ${isTesting || !apiKey
