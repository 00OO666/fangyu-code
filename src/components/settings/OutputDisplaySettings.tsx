  ...
  return (
    <Card className="p-4 space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Button variant="ghost" size="sm" onClick={resetSettings} className="h-7 text-xs gap-1">
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-0.5 flex-1">
            <Label htmlFor="showAllMessages" className="text-sm">
              显示所有消息
            </Label>
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-0.5 flex-1">
            <div className="flex items-center gap-1.5">
              ...
              <Label htmlFor="showThinkingProcess" className="text-sm">
                显示思考过程
              </Label>
            </div>
            <p className="text-[11px] text-muted-foreground">
        ...
        <div className="flex items-center justify-between pl-5">
          <div className="space-y-0.5 flex-1">
            <Label htmlFor="defaultExpandThinking" className="text-sm">
              默认展开思考过程
            </Label>
            <p className="text-[11px] text-muted-foreground">
              思考过程区块默认展开显示（而非折叠）
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-0.5 flex-1">
            <div className="flex items-center gap-1.5">
              ...
              <Label htmlFor="showToolResults" className="text-sm">
                显示工具执行结果
              </Label>
            </div>
            <p className="text-[11px] text-muted-foreground">
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-0.5 flex-1">
            <Label htmlFor="showSystemMessages" className="text-sm">
              显示系统消息
            </Label>
            <p className="text-[11px] text-muted-foreground">显示启动警告、MCP 初始化等系统消息</p>
          </div>
          <Switch
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-0.5 flex-1">
            <Label htmlFor="showWarmupMessages" className="text-sm">
              显示 Warmup 消息
            </Label>
            <p className="text-[11px] text-muted-foreground">显示系统预热消息及其回复</p>
          </div>
          <Switch
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-0.5 flex-1">
            <Label htmlFor="showAutoContinueMessages" className="text-sm">
              显示自动继续消息
            </Label>
            <p className="text-[11px] text-muted-foreground">显示系统自动发送的继续执行消息</p>
          </div>
          <Switch
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-0.5 flex-1">
            ...
            <p className="text-[11px] text-muted-foreground">显示额外的调试信息（开发者选项）</p>
          </div>
          <Switch
            id="showDebugInfo"
