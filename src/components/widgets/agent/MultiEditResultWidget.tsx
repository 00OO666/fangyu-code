 ...
 */
export const MultiEditResultWidget: React.FC<MultiEditResultWidgetProps> = ({ content, edits }) => {
    ...
    return (
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-2 px-3 py-2 bg-success/10 rounded-t-md border-b border-success/20">
          ...
          <span className="text-sm font-medium text-success">{edits.length} 个更改已应用</span>
        </div>
