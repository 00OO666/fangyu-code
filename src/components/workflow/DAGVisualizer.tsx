    ...
    >
        ...
        <div className="flex items-center gap-2 flex-1 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 mt-1">
              <Badge variant="outline" className={cn('text-[10px] px-1.5 py-0', PRIORITY_COLORS[data.priority])}>
                {data.priority}
              </Badge>
      ...
      <div className="px-3 py-2">
        ...
        >
          ...
          {data.requiredSkills.length} 技能 · {data.requiredTools.length} 工具 · {data.dependencies.length} 依赖
        </button>
            ...
            >
              <div className="mt-2 space-y-2 text-xs">
                ...
                {data.subtasks && data.subtasks.length > 0 && (
                  <div>
                    <div className="text-muted-foreground mb-1">子任务 ({data.subtasks.length})：</div>
...
export const DAGVisualizer: React.FC<DAGVisualizerProps> = ({
  ...
  const stats = useMemo(() => {
    ...
    const pending = workflow.tasks.filter(t => t.status === 'pending' || t.status === 'queued').length;
                  ...
                  <React.Fragment key={taskId}>
                    ...
                    <Badge
                      ...
                      className={cn(
                        ...
                        task?.status === 'in_progress' && 'bg-blue-100 border-blue-300 animate-pulse'
                      )}
                    >
