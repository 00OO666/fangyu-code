...
// 生成安全的路径段
const safePathSegmentArb = fc.array(safeFilenameArb, { minLength: 1, maxLength: 5 })
...
describe('SecurityGuard Property Tests', () => {
  ...
  describe('Audit Log Properties (Property 22)', () => {
    ...
    it('Property 22.4: 审计统计应正确计算', () => {
      ...
      guard.logOperation({ type: 'command.execute', target: 'd', timestamp: Date.now() }, 'blocked', 10);
