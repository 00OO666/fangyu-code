...
export const dependencyReducer = (
    ...
    switch (action.type) {
        ...
        case 'CHECK_SUCCESS': {
            ...
            const shouldInstall =
                state.context.requiresCli &&
                hasInstallPrereqs(dependencies) &&
        ...
        case 'INSTALL_SUCCESS': {
            const nextDependencies =
                action.payload?.dependencies ?? state.context.dependencies;
        ...
        case 'APPEND_LOG':
            ...
            return {
                ...
                context: {
                    ...state.context,
                    logs: [
                        ...state.context.logs.slice(-MAX_LOG_ENTRIES + 1),
...
export const useDependencyStateMachine = (
    options?: UseDependencyStateMachineOptions
) => {
