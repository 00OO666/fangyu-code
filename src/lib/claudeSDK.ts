...
export class ClaudeSDKService {
  ...
  async sendMessageDirect(
    ...
    const apiKey =
      providerConfig.anthropic_api_key || providerConfig.anthropic_auth_token || this.config.apiKey;
    ...
    let baseURL =
      providerConfig.anthropic_base_url || this.config.baseURL || "https://api.anthropic.com";
