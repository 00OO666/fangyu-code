...
export function mergeConfigurations(
  ...
  return {
    ...
    ...enhanced,
    // 如果两者都有相同事件，合并它们
    PreToolUse: [...(converted.PreToolUse || []), ...(enhanced.PreToolUse || [])],
    PostToolUse: [...(converted.PostToolUse || []), ...(enhanced.PostToolUse || [])],
    Notification: [...(converted.Notification || []), ...(enhanced.Notification || [])],
    Stop: [...(converted.Stop || []), ...(enhanced.Stop || [])],
    SubagentStop: [...(converted.SubagentStop || []), ...(enhanced.SubagentStop || [])],
  };
}
