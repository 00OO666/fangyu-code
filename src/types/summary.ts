...
export const ENGINE_MODELS: Record<SummaryEngine, ModelInfo[]> = {
    ...
    codex: [
        ...
        { id: 'gpt-4o-mini', name: 'GPT-4o Mini', costPer1k: 0.00015, maxContext: 128000, recommended: true },
...
/** 引擎显示信息 */
export const ENGINE_DISPLAY_INFO: Record<SummaryEngine, Omit<EngineInfo, 'available' | 'version' | 'models'>> = {
    claude: {
        id: 'claude',
        name: 'Claude',
        color: '#FF6B35',
